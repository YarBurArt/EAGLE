...
def upgrade():
    ...
    op.add_column(
        "agent", sa.Column("agent_name", sa.String(length=256), nullable=False)
    )
    ...
    op.add_column(
        "agent", sa.Column("callback_display_id", sa.Integer(), nullable=False)
    )
    ...
    op.add_column(
        "attack_chain", sa.Column("chain_name", sa.String(length=256), nullable=False)
    )
    op.add_column(
        "attack_chain", sa.Column("final_status", sa.String(length=64), nullable=False)
    )
    op.create_unique_constraint(None, "attack_chain", ["chain_name"])
    op.add_column(
        "attack_step", sa.Column("phase", sa.String(length=64), nullable=False)
    )
    op.add_column(
        "attack_step", sa.Column("tool_name", sa.String(length=64), nullable=False)
    )
    op.add_column("attack_step", sa.Column("command", sa.Text(), nullable=False))
    op.add_column(
        "attack_step", sa.Column("mythic_task_id", sa.Integer(), nullable=False)
    )
    op.add_column(
        "attack_step",
        sa.Column("mythic_payload_uuid", sa.Uuid(as_uuid=False), nullable=False),
    )
    op.add_column(
        "attack_step", sa.Column("mythic_payload_id", sa.Integer(), nullable=False)
    )
    op.add_column("attack_step", sa.Column("raw_log", sa.Text(), nullable=True))
    op.add_column(
        "attack_step", sa.Column("status", sa.String(length=64), nullable=False)
    )
    op.add_column(
        "attack_step",
        sa.Column(
    ...
    op.alter_column(
        "user_account", "username", existing_type=sa.VARCHAR(length=256), nullable=True
    )
    op.alter_column(
        "user_account", "role", existing_type=sa.VARCHAR(length=64), nullable=True
    )
...
def downgrade():
    ...
    op.create_unique_constraint(
        op.f("user_account_role_key"),
        "user_account",
        ["role"],
        postgresql_nulls_not_distinct=False,
    )
    op.alter_column(
        "user_account", "role", existing_type=sa.VARCHAR(length=64), nullable=False
    )
    op.alter_column(
        "user_account", "username", existing_type=sa.VARCHAR(length=256), nullable=False
    )
    ...
    op.create_unique_constraint(
        op.f("agent_role_key"), "agent", ["role"], postgresql_nulls_not_distinct=False
    )
